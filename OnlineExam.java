...
{  
    ...
    {  
        ...
        if(current==0)  
        {  
            l.setText("Question 1:What is the Scientific Name  of computer?");  
            jb[0].setText("Homo Sapiens");jb[1].setText("Sillico Sapiens");jb[2].setText("rattus");jb[3].setText("Ovis aries");   
        }  
        if(current==1)  
        {  
            l.setText("Question 2: What is the full form of CPU ?");  
            jb[0].setText("Computer Processing");jb[1].setText("Computer Principle Unit");jb[2].setText("Central Processing Unit");jb[3].setText("Control Processing Unit");  
        }  
        if(current==2)  
        {  
        ...
        if(current==8)  
        {  
            l.setText("Question 9: Which of the following is the brain of the computer?");  
            jb[0].setText("Central Processing Unit");jb[1].setText("Memory");jb[2].setText("Arithmetic and Logic Unit");jb[3].setText("Control Unit");  
        }  
        if(current==9)  
        {  
            l.setText("Question 10: Which of the following computer language is written in binary codes only?");  
            jb[0].setText("pascal");jb[1].setText("machine language");jb[2].setText("c");  
                        jb[3].setText("C#");  
        }  
        l.setBounds(30,40,450,20);  
